      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Ventas semanales</span>
              <div class="count green">30</div>
          </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Ventas Diarias</span>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          <tr>
                            <td>
                              <p><i class="fa fa-square blue"></i>Burrito Mixto </p>
                            </td>
                            <td>30%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>Taco de Pollo </p>
                            </td>
                            <td>10%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Sandwich Pollo </p>
                            </td>
                            <td>20%</td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Jugo (Limonada) </p>
                            </td>
                            <td>15%</td>
                          </tr>
                          <tr>
        ...
        <footer>
          <div class="pull-right">
            Gallo - Galanazo <a href="#">Buuweb </a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
