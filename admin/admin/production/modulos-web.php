        ...
        <div class="right_col" role="main">
          <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Listado de Modulos
                    <small>
                      <?php         
                          // $navegador = new ModeloNavegador($idioma);
                ...
                <div class="x_content">
                  <?php 
                        ...
                        $obj_categoria  = new ModeloCategoria($idcat, $idioma);
                        $obj_c          = new ModeloCategorias($idioma, $msgbox);
                        $obj            = new ModeloProductos($idioma, $msgbox, $user);
